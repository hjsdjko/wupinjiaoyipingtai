...
public class WupinCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public WupinCollectionEntity() {

	}

	public WupinCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "WupinCollection{" +
            "id=" + id +
            ", wupinId=" + wupinId +
            ", yonghuId=" + yonghuId +
            ", wupinCollectionTypes=" + wupinCollectionTypes +
