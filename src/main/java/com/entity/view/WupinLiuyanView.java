...
public class WupinLiuyanView extends WupinLiuyanEntity implements Serializable {
	...
	public WupinLiuyanView() {

	}

	public WupinLiuyanView(WupinLiuyanEntity wupinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, wupinLiuyanEntity);
