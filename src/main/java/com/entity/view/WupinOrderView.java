...
public class WupinOrderView extends WupinOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String wupinOrderValue;
		/**
		* 支付类型的值
		*/
		private String wupinOrderPaymentValue;
	...
	public WupinOrderView() {

	}

	public WupinOrderView(WupinOrderEntity wupinOrderEntity) {
		try {
			BeanUtils.copyProperties(this, wupinOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getWupinOrderValue() {
				return wupinOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setWupinOrderValue(String wupinOrderValue) {
				this.wupinOrderValue = wupinOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getWupinOrderPaymentValue() {
				return wupinOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setWupinOrderPaymentValue(String wupinOrderPaymentValue) {
				this.wupinOrderPaymentValue = wupinOrderPaymentValue;
			}
